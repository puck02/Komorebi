...
TEMPLATE_RECIPE_TAGS = {
    ...
    "map_journey": ["travel", "route", "ticket", "date", "memory"],
    "weekly_spread": ["date", "checklist", "note", "pen", "daily"],
    "day_dashboard": ["checklist", "date", "note", "pen", "daily"],
    "scrapbook_story": ["photo", "corner", "collage", "memory", "warm"],
